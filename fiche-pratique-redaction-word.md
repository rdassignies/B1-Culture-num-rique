...
**Quand les utiliser** : Étapes, priorités, ordre chronologique
...
**Orphelines** : Première ligne d'un paragraphe seule en bas de page

**Activer la protection** :
1. Sélectionner tout le texte (Ctrl + A)
2. Clic droit > Paragraphe > Enchaînements
3. Cocher "Éviter veuves et orphelines"
4. Cocher "Lignes solidaires" pour les titres
...
- ☑ Éviter tableaux trop complexes
- ☑ Liens descriptifs (pas "cliquez ici")
- ☑ Structure avec styles (pas juste mise en gras)

### Compatibilité

**Format d'enregistrement** :
- **Travail en cours** : .docx (Word 2007 et +)
- **Version finale** : .docx + PDF
- **Archivage** : PDF/A (conservation longue durée)

**Avant envoi** :
- Tester ouverture sur autre ordinateur
- Vérifier que polices sont intégrées (Fichier > Options > Enregistrement > Incorporer les polices)

---

## 10. Formules et conventions juridiques

### Formules de politesse

**Début** :
- Madame, Monsieur, (virgule, pas deux-points)
- Madame la Présidente, / Monsieur le Juge,
...
## Mémo rapide - Les 10 règles d'or
